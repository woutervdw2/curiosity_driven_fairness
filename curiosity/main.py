...
def main():
    #Constants
    LEARNING_STEPS = [300000, 600000]
    MODELS = ['visit_count', 'UCB', 'scalar']
    curiosity = [0.1, 1, 2]
    for c in curiosity:
        for n_steps in LEARNING_STEPS:
            model_name = f'ppo_lending/{n_steps}_{c}_boosted'
            ...
            for model in MODELS:
                print(f"Assessing {model} with curiosity {c} and time steps {n_steps}")
